...
use BitBag\OpenMarketplace\Importer\Common\Trait\ImporterImageAwareTrait;
    ...
    public function handle(
        ...
        try {
            ...
            foreach ($imagesArray as $image) {
                ...
                $this->imageExists($filePath, $imageUrl);

                $uploadedImage = new UploadedFile($filePath, $filename);
