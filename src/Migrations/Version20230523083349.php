...
final class Version20230523083349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation ADD CONSTRAINT FK_A8BC415912469DE2 FOREIGN KEY (category_id) REFERENCES bitbag_open_marketplace_conversation_category (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation ADD CONSTRAINT FK_A8BC4159A45D93BF FOREIGN KEY (shop_user_id) REFERENCES sylius_shop_user (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message ADD CONSTRAINT FK_47BF407BA45D93BF FOREIGN KEY (shop_user_id) REFERENCES sylius_shop_user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message ADD CONSTRAINT FK_47BF407BB919EBFA FOREIGN KEY (vendor_user_id) REFERENCES bitbag_open_marketplace_vendor (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message ADD CONSTRAINT FK_47BF407B6352511C FOREIGN KEY (admin_user_id) REFERENCES sylius_admin_user (id)');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message ADD CONSTRAINT FK_47BF407B9AC0396 FOREIGN KEY (conversation_id) REFERENCES bitbag_open_marketplace_conversation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute ADD CONSTRAINT FK_3D38CB8F3B420C91 FOREIGN KEY (product_attribute_id) REFERENCES sylius_product_attribute (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute ADD CONSTRAINT FK_3D38CB8FF603EE73 FOREIGN KEY (vendor_id) REFERENCES bitbag_open_marketplace_vendor (id)');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute_translation ADD CONSTRAINT FK_DE55497D2C2AC5D3 FOREIGN KEY (translatable_id) REFERENCES bitbag_open_marketplace_draft_attribute (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute_value ADD CONSTRAINT FK_FF406DE223EDC87 FOREIGN KEY (subject_id) REFERENCES bitbag_open_marketplace_product_draft (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute_value ADD CONSTRAINT FK_FF406DE2B6E62EFA FOREIGN KEY (attribute_id) REFERENCES bitbag_open_marketplace_draft_attribute (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft ADD CONSTRAINT FK_2C636C234706C231 FOREIGN KEY (product_listing_id) REFERENCES bitbag_open_marketplace_product_listing (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft ADD CONSTRAINT FK_2C636C23731E505 FOREIGN KEY (main_taxon_id) REFERENCES sylius_taxon (id)');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft ADD CONSTRAINT FK_2C636C239E2D1A41 FOREIGN KEY (shipping_category_id) REFERENCES sylius_shipping_category (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft_channels ADD CONSTRAINT FK_2BDC3F714584665A FOREIGN KEY (product_id) REFERENCES bitbag_open_marketplace_product_draft (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft_channels ADD CONSTRAINT FK_2BDC3F7172F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing ADD CONSTRAINT FK_3DEC01B6B92E09BA FOREIGN KEY (latest_draft_id) REFERENCES bitbag_open_marketplace_product_draft (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing ADD CONSTRAINT FK_3DEC01B6F603EE73 FOREIGN KEY (vendor_id) REFERENCES bitbag_open_marketplace_vendor (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing ADD CONSTRAINT FK_3DEC01B64584665A FOREIGN KEY (product_id) REFERENCES sylius_product (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_image ADD CONSTRAINT FK_EECB9587E3C61F9 FOREIGN KEY (owner_id) REFERENCES bitbag_open_marketplace_product_draft (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_price ADD CONSTRAINT FK_1199FDE2943AF46 FOREIGN KEY (product_draft_id) REFERENCES bitbag_open_marketplace_product_draft (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_taxons ADD CONSTRAINT FK_C4FE96562943AF46 FOREIGN KEY (product_draft_id) REFERENCES bitbag_open_marketplace_product_draft (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_taxons ADD CONSTRAINT FK_C4FE9656DE13F470 FOREIGN KEY (taxon_id) REFERENCES sylius_taxon (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_translation ADD CONSTRAINT FK_FC1827612943AF46 FOREIGN KEY (product_draft_id) REFERENCES bitbag_open_marketplace_product_draft (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor ADD CONSTRAINT FK_9FA05F8A6FC27B12 FOREIGN KEY (vendor_address_id) REFERENCES bitbag_open_marketplace_vendor_address (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor ADD CONSTRAINT FK_9FA05F8AA76ED395 FOREIGN KEY (user_id) REFERENCES sylius_shop_user (id)');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_address ADD CONSTRAINT FK_242A2F9FF92F3E70 FOREIGN KEY (country_id) REFERENCES sylius_country (id)');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_address_update ADD CONSTRAINT FK_2A4D6C01F92F3E70 FOREIGN KEY (country_id) REFERENCES sylius_country (id)');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_background_image ADD CONSTRAINT FK_86DFF17E7E3C61F9 FOREIGN KEY (owner_id) REFERENCES bitbag_open_marketplace_vendor (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_image ADD CONSTRAINT FK_F14961AF7E3C61F9 FOREIGN KEY (owner_id) REFERENCES bitbag_open_marketplace_vendor (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update ADD CONSTRAINT FK_793E8ED96FC27B12 FOREIGN KEY (vendor_address_id) REFERENCES bitbag_open_marketplace_vendor_address_update (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update ADD CONSTRAINT FK_793E8ED9F603EE73 FOREIGN KEY (vendor_id) REFERENCES bitbag_open_marketplace_vendor (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update_background_image ADD CONSTRAINT FK_B564BE8E7E3C61F9 FOREIGN KEY (owner_id) REFERENCES bitbag_open_marketplace_vendor_profile_update (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update_image ADD CONSTRAINT FK_3F36779A7E3C61F9 FOREIGN KEY (owner_id) REFERENCES bitbag_open_marketplace_vendor_profile_update (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_shipping_method ADD CONSTRAINT FK_78DA976F603EE73 FOREIGN KEY (vendor_id) REFERENCES bitbag_open_marketplace_vendor (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_shipping_method ADD CONSTRAINT FK_78DA9765F7D6850 FOREIGN KEY (shipping_method_id) REFERENCES sylius_shipping_method (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation DROP FOREIGN KEY FK_A8BC415912469DE2');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation DROP FOREIGN KEY FK_A8BC4159A45D93BF');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message DROP FOREIGN KEY FK_47BF407BA45D93BF');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message DROP FOREIGN KEY FK_47BF407BB919EBFA');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message DROP FOREIGN KEY FK_47BF407B6352511C');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_conversation_message DROP FOREIGN KEY FK_47BF407B9AC0396');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute DROP FOREIGN KEY FK_3D38CB8F3B420C91');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute DROP FOREIGN KEY FK_3D38CB8FF603EE73');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute_translation DROP FOREIGN KEY FK_DE55497D2C2AC5D3 ');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute_value DROP FOREIGN KEY FK_FF406DE223EDC87 ');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_draft_attribute_value DROP FOREIGN KEY FK_FF406DE2B6E62EFA ');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft DROP FOREIGN KEY FK_2C636C234706C231 ');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft DROP FOREIGN KEY FK_2C636C23731E505');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft DROP FOREIGN KEY FK_2C636C239E2D1A41');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft_channels DROP FOREIGN KEY FK_2BDC3F714584665A');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_draft_channels DROP FOREIGN KEY FK_2BDC3F7172F5A1AA');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing DROP FOREIGN KEY FK_3DEC01B6B92E09BA');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing DROP FOREIGN KEY FK_3DEC01B6F603EE73');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing DROP FOREIGN KEY FK_3DEC01B64584665A');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_image DROP FOREIGN KEY FK_EECB9587E3C61F9');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_price DROP FOREIGN KEY FK_1199FDE2943AF46');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_taxons DROP FOREIGN KEY FK_C4FE96562943AF46');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_listing_taxons DROP FOREIGN KEY FK_C4FE9656DE13F470');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_product_translation DROP FOREIGN KEY FK_FC1827612943AF46');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor DROP FOREIGN KEY FK_9FA05F8A6FC27B12');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor DROP FOREIGN KEY FK_9FA05F8AA76ED395');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_address DROP FOREIGN KEY FK_242A2F9FF92F3E70');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_address_update DROP FOREIGN KEY FK_2A4D6C01F92F3E70');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_background_image DROP FOREIGN KEY FK_86DFF17E7E3C61F9');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_image DROP FOREIGN KEY FK_F14961AF7E3C61F9');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update DROP FOREIGN KEY FK_793E8ED96FC27B12');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update DROP FOREIGN KEY FK_793E8ED9F603EE73');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update_background_image DROP FOREIGN KEY FK_B564BE8E7E3C61F9');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_profile_update_image DROP FOREIGN KEY FK_3F36779A7E3C61F9');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_shipping_method DROP FOREIGN KEY FK_78DA976F603EE73');
        $this->addSql('ALTER TABLE bitbag_open_marketplace_vendor_shipping_method DROP FOREIGN KEY FK_78DA9765F7D6850');
